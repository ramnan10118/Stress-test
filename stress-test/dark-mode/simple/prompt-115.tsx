...
export default function Prompt115() {
  return (
    <div data-theme="dark" style={{ minHeight: "100vh", background: "var(--color-surface)", display: "flex", flexDirection: "column" }}>
      ...
      <main style={{
        ...
        {/* Success hero — sparse content: large type, centered, generous whitespace */}
        ...
        {/* Policy summary card — padding="md" = 20px all sides */}
        ...
        <div style={{ width: "100%", display: "flex", flexDirection: "column", gap: "var(--space-3)" }}>
          ...
          <Button type="button" variant="outline" size="md" fullWidth>
            <Share2 size={16} aria-hidden="true" style={{ marginRight: "var(--space-2)" }} />
            Share via WhatsApp
          </Button>
        </div>
