...
// Iteration 5: +UX researcher — collapsible inclusions (show 2, "See all N")
export default function Prompt210() {
            ...
            {PLANS.map((plan) => {
              ...
              return (
                <Card key={plan.id} variant="default" padding="md" style={plan.recommended ? { borderColor: "var(--color-primary)", borderWidth: 2 } : undefined}>
                  ...
                  {/* CHANGED: Collapsible inclusions */}
                  ...
                  {hasMore && (
                    <button
                      ...
                      style={{
                        ...
                        color: "var(--color-primary)", touchAction: "manipulation",
                      }}
                    >
                      <Typography variant="label-sm" weight="semibold" color="primary">
                        {isExpanded ? "Show less" : `See all ${plan.inclusions.length} benefits`}
                      </Typography>
                  ...
                  <Typography variant="caption" color="muted" style={{ display: "block", marginTop: "var(--space-3)" }}>
                    Premium inclusive of GST. Subject to underwriting.
                  </Typography>
                </Card>
              );
            })}
