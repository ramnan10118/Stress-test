...
export default function Prompt206() {
  return (
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "var(--space-3)" }}>
          {PLANS.map((plan) => (
            <Card
              ...
              variant="default"
              padding="md"
              style={plan.recommended ? { borderColor: "var(--color-primary)", borderWidth: 2 } : undefined}
            >
              {plan.recommended && (
              ...
              <Typography variant="display-sm" weight="bold" color="strong" style={{ display: "block", marginBottom: "var(--space-4)", fontVariantNumeric: "tabular-nums" }}>
              ...
              <Button type="button" variant={plan.recommended ? "primary" : "outline"} size="md">
                Select plan
              </Button>
            </Card>
          ))}
