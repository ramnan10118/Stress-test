...
import { ChevronLeft, Check, X, ChevronDown, ChevronUp, TrendingUp, Info } from "lucide-react";
...
const PLANS: Plan[] = [
  { id: "tp", name: "Third Party", premium: 2094, marketPremium: 2094, recommended: false, popular: false, accentColor: "var(--color-text-muted)", inclusions: ["Third party liability", "Personal accident cover", "Legal liability", "No own damage cover"] },
  { id: "comp", name: "Comprehensive", premium: 5782, marketPremium: 8200, recommended: true, popular: true, accentColor: "var(--color-primary)", inclusions: ["Own damage + third party", "Personal accident cover", "Cashless repairs at 3,000+ garages", "24×7 roadside assistance"] },
  { id: "total", name: "ACKO Total Protect", premium: 7499, marketPremium: 11500, recommended: false, popular: false, accentColor: "var(--color-success)", inclusions: ["Everything in Comprehensive", "Zero depreciation cover", "Engine protection", "Return to invoice"] },
];
...
// Iteration 9: +PM — savings callout (vs market price), info tooltip on "Starting from"
export default function Prompt214() {
              ...
              return (
                <div key={plan.id} role="listitem">
                  <Card variant="default" padding="md" style={{ position: "relative", overflow: "hidden", ...(plan.recommended ? { borderColor: "var(--color-primary)", borderWidth: 2 } : {}) }}>
                    ...
                    {/* CHANGED: "Starting from" now has info tooltip */}
