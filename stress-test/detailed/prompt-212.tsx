...
// Iteration 7: +QA — responsive horizontal scroll on compare table, consistent 12px card gap, min-width on table columns
export default function Prompt212() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "var(--color-surface)", display: "flex", flexDirection: "column" }}>
      ...
      <main style={{ flex: 1, padding: "var(--space-5)", paddingBottom: "var(--space-20)", maxWidth: 480, margin: "0 auto", width: "100%", display: "flex", flexDirection: "column", gap: "var(--space-6)" }}>
        ...
        <div style={{ background: "var(--color-surface-accent)", borderRadius: "var(--radius-xl)", padding: "var(--space-3) var(--space-4)", display: "flex", alignItems: "center", gap: "var(--space-3)" }}>
        ...
        {view === "card" ? (
          /* CHANGED: Enforced consistent gap of var(--space-3) = 12px between cards */
          ...
          /* CHANGED: Responsive compare — overflowX auto, min-width on table, -webkit-overflow-scrolling */
          <div style={{ overflowX: "auto", WebkitOverflowScrolling: "touch" }}>
            ...
            {/* CHANGED: Buttons now also inside scroll container, matching column widths */}
