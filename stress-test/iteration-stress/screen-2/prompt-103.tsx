// Iteration 3: Home dashboard + renewal reminder banner
import { Bell, Car, ChevronRight, FileText, Phone, Home, User, AlertCircle } from "lucide-react";
...
export default function Prompt103() {
  return (
    <div style={{ minHeight: "100vh", background: "var(--color-surface)", display: "flex", flexDirection: "column" }}>
      ...
      <main style={{ flex: 1, padding: "var(--space-5) var(--space-4)", paddingBottom: "calc(var(--scale-64) + var(--space-5))", display: "flex", flexDirection: "column", gap: "var(--space-5)", maxWidth: 480, margin: "0 auto", width: "100%" }}>
        {/* Renewal banner */}
        <Card variant="default" padding="none" style={{ border: "1px solid var(--color-warning-border)", background: "var(--color-warning-subtle)" }}>
          <CardContent>
            <div style={{ display: "flex", alignItems: "flex-start", gap: "var(--space-3)" }}>
              <div style={{ color: "var(--color-warning)", flexShrink: 0, paddingTop: "var(--space-1)" }}>
                <AlertCircle size={18} aria-hidden="true" />
              </div>
              <div style={{ flex: 1 }}>
                <Typography variant="label-lg" weight="semibold" color="strong" style={{ display: "block", marginBottom: "var(--space-1)" }}>
                  Policy expiring in 14 days
                </Typography>
                <Typography variant="body-sm" color="muted" style={{ marginBottom: "var(--space-3)", display: "block" }}>
                  Your car insurance expires on 12 Mar 2026. Renew now to stay protected.
                </Typography>
        ...
        <div>
          ...
          <Typography variant="body-sm" color="muted">1 policy needs your attention.</Typography>
        </div>
            ...
            <CardContent>
              <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: "var(--space-3)" }}>
                ...
                <div style={{ display: "flex", alignItems: "center", gap: "var(--space-2)", flexShrink: 0 }}>
                  <Badge color="yellow" size="sm">Expiring</Badge>
